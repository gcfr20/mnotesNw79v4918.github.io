...
.. math::
    ...
    83521 &= 1+10\times 2+100\times 5+1000\times 3+10000\times 8

    &= 10^0+10^1\times 2+10^2\times 5+10^3\times 3 + 10^4\times 8
...
To identify what basis is being used, we will write :math:`83521` as :math:`83521_{10}`

======================================

Remark: 83521 can be written in other ways too. A couple of examples are given below.

.. math::

   83521 &= 521 + 1000\times 83

   &= 21 + 100\times 835
   
======================================
   
Sometimes, when repeating patterns are involved, it is useful to use powers of 10 that match the pattern. Here is an example.

.. math::

   231231231 &= 231 + 10^3\times 231 + 10^6\times 231

   &=231\times(1+10^3+10^6)=231\times 1001001

======================================

Another set of interesting numbers are numbers of the form :math:`111...111`. If the number of digits is composite, tehn this number will not be a prime. Example, suppose the number of digits is a multiple of 5, we can treat the repeating pattern to be of length 5.

.. math::

   111111111111111 &= 11111 + 10^5\times 11111 + 10^{10}\times 11111

   &= 11111 \times 10000100001
...
.. math::
   ...
   5_{10}=101_{2}=\left(2^0\times 1 + 2^1\times 0+2^2\times 1\right)_{10}

In base 5, the numbers will look like 0, 1, 2, 3, 4, 10, 11, 12, 13, 14, 20, 21, 22, ..., 44, 100, 101, 102, 103, 104, 110, ..., 444, 1000.

.. math::

   423_{5}=\left(5^0\times 3+5^1\times 2+5^2\times 4\right)_{10}=113_{10}
...
.. math::
   ...
   3D_{16}=\left(16^0\times 13+ 16^1\times 3\right)_{10}=61_{16}
...
.. math::
   ...
   212_{10}&=\left(10^0\times 2+10^1\times 1+10^2\times 2\right)_{10}
   
   &=\left(16^0\times 4+16^1\times 13\right)_{10}
   
   &=\left(10^0\times 4 + 10^1\times D\right)_{16}
...
The process is continued until the quotient is 0. The remainders in the desired base are then written in reverse (bottom to top)  giving 212\ :sub:`10`\ =D4\ :sub:`16`\.

Another example: Convert :math:`168_{10}` to base :math:`3`
