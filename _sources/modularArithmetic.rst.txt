...
:math:`(a+c)\equiv (b+d)~(mod~n)~[i],~ac\equiv bd~(mod~n)~[ii]`.

It follows that :math:`ak\equiv bk~(mod~n)~[iii]` as :math:`k\equiv k~(mod~n)` for any integer :math:`k`. Additionally, successive multiplication gives :math:`a^k\equiv b^k~(mod~n)~[iv]`.
...
.. math::
   ...
   & (-4)(-1)\equiv (3)(-1)~(mod~7)~\text{(Using $[iii]$)}

   & 4\equiv -3~(mod~7)

   &~
   
   & (-4)(2)\equiv (3)(2)~(mod~7)~\text{(Using $[iii]$)}

   & -8\equiv 6~(mod~7) 

   &~

   & (-4)^2\equiv (3)^2~(mod~7)~\text{(Using $[iv]$)}
